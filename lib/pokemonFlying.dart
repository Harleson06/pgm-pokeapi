...
class PokemonVoador extends StatefulWidget {
  final String pokemonType;

  const PokemonVoador({Key? key, required this.pokemonType}) : super(key: key);

  @override
  _PokemonVoadorState createState() => _PokemonVoadorState();
}

class _PokemonVoadorState extends State<PokemonVoador> {
  List<dynamic> pokemonList = [];

  Future<void> fetchPokemonData() async {
    final response = await http.get(Uri.parse('https://pokeapi.co/api/v2/type/flying'));
